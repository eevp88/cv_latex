...
\begin{center}
    ...
    % \href{https://eevp.dev/}{\raisebox{-0.2\height}\faDesktop\ \underline{eevp.dev}} ~ 
...
\section{Experiencia}
    \resumeSubHeadingListStart
      \resumeSubheading{West Ingenieria}{Valdivia, Chile}
        \resumeSubSubheading{Líder Técnico}{ago 2024 - mar 2025}
          \resumeItemListStart
              \resumeItem{Lideré un equipo ágil de desarrollo conformado por 4 desarrolladores, asignando tareas según fortalezas individuales y prioridades técnicas.}
          ...
          \resumeItemListEnd
        \resumeSubSubheading{Ingeniero de Software}{may 2017 - ago 2024}
          \resumeItemListStart
            ...
            \resumeItem{Proyecto: Forestruck7 - Forestal Arauco, Forestal y Maderas Anchile, Trans Pacific Fibre, entre otros.}
              \resumeItemListStart
                  \resumeItem{Participé en el diseño funcional y técnico de un módulo que emite más de 80.000 guías mensuales para recepción y despacho de madera.}
      ...
      %  \resumeSubheading{Universidad Austral de Chile}{Valdivia, Chile}
       ...
       %         \resumeItem{Soporte técnico y Mantenimiento de sitio web institucional en la Facultad de Ciencias Jurídicas y Sociales.}  
                %\resumeItem{Apoyo a la docencia en laboratorios, clases prácticas y toma de pruebas en la Facultad de Ciencias de la Ingeniería.}   
        %      \resumeItemListEnd
      ...
      \resumeSubheading{Bolsa de Comercio de Santiago}{Santiago, Chile}
           \resumeSubSubheading{Practicante}{ene 2013 - mar 2013}
             \resumeItemListStart
